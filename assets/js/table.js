...
const postPagePath = window.mavsideResolvePath ? window.mavsideResolvePath('/view/add.html') : '/view/add.html';
...
async function acceptRequest(requestId) {
    ...
    if (targetItem.sourceType === 'order' && targetItem.sourceOrderId && typeof window.claimOrder === 'function') {
        ...
        applyFilters();
        window.location.href = (window.mavsideResolvePath ? window.mavsideResolvePath('/view/order-tracking.html') : '/view/order-tracking.html') + '?orderId=' + encodeURIComponent(targetItem.sourceOrderId) + '&kind=order&role=bringer';
        return;
    }
    ...
    if (changed) {
        ...
        window.location.href = (window.mavsideResolvePath ? window.mavsideResolvePath('/view/order-tracking.html') : '/view/order-tracking.html') + '?kind=errand&id=' + encodeURIComponent(requestId) + '&role=bringer';
    }
}
